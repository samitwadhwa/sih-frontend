...
<input type="checkbox" id="startup" name="startup"  value={Formvalues.role} onChange={handleChange}/>
  <label htmlFor="startup">Startup</label> <br/>
  <input type="checkbox" id="teacher" name="teacher" onChange={handleChange}  value={Formvalues.role}/>
